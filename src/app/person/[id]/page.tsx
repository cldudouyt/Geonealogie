        ...
        <div className="relative z-10 px-6 pb-8 pt-6 flex items-end gap-5">
          ...
          <div style={{ position: 'relative', flexShrink: 0 }}>
            ...
            {canEdit && (
              <Link
                href={`/person/${id}/edit`}
                style={{ position: 'absolute', bottom: -4, right: -4, background: '#1e3a2f', borderRadius: '50%', width: 34, height: 34, display: 'flex', alignItems: 'center', justifyContent: 'center', border: '2px solid white', color: 'white' }}
